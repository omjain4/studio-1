...
import { Clock, Ticket, Route, GalleryHorizontal, BookOpen, Calendar, Video, Landmark } from 'lucide-react';
      ...
      <div className="container max-w-7xl mx-auto py-12 px-4">
        <Tabs defaultValue="history" className="w-full">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-5 h-auto mb-8">
            ...
            <TabsTrigger value="tour"><Video className="w-4 h-4 mr-2" />360° View</TabsTrigger>
